...
public class Control : MonoBehaviour
{
    ...
    public void UpdateRotate(float mouseX,float mouseY)
    {
        ...
        eulerAngleY += mouseX * axisspeed; // 마우스 좌/우 이동으로 카메라 y축 이동

        // 마우스 아래로 내리면 -로 음수인데 오브젝츠의 x축의 + 방향으로 회전해야 아래를 보기 떄문이다

        eulerAngleX -= mouseY * axisspeed; // 마우스 위/아래 이동으로 카메라 x축 이동
